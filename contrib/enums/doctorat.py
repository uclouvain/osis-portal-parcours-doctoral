...
class ChoixStatutDoctorat(ChoiceEnum):
    ...
    DEFENSE_PRIVEE_ET_SOUTENANCE_PUBLIQUE_SOUMISES = _('DEFENSE_PRIVEE_ET_SOUTENANCE_PUBLIQUE_SOUMISES')
    DEFENSE_PRIVEE_ET_SOUTENANCE_PUBLIQUE_AUTORISEES = _('DEFENSE_PRIVEE_ET_SOUTENANCE_PUBLIQUE_AUTORISEES')
    # Autres
    PROCLAME = _('PROCLAME')
    ABANDON = _('ABANDON')
