...
from parcours_doctoral.contrib.forms.project import COMMISSION_CDSS, SCIENCE_DOCTORATE
...
class ProjectViewTestCase(TestCase):
    ...
    def test_update(self):
        url = resolve_url('parcours_doctoral:update:project', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
    ...
    def test_detail_redirect(self):
        url = resolve_url('parcours_doctoral', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        response = self.client.get(url)
        project_url = resolve_url('parcours_doctoral:project', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        self.assertRedirects(response, project_url)

    def test_detail(self):
        url = resolve_url('parcours_doctoral:project', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        self.mock_proposition_api.return_value.retrieve_doctorate_proposition.return_value = Mock(
    ...
    def test_cancel(self):
        url = resolve_url('parcours_doctoral:cancel', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        self.mock_proposition_api.return_value.retrieve_doctorate_proposition.return_value = Mock(
            statut=ChoixStatutDoctorat.ADMITTED.name,
            links={},
        )
        response = self.client.get(url)
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, ChoixStatutDoctorat.ADMITTED.value)
    ...
    def test_cancel_general_education_proposition(self):
        url = resolve_url('parcours_doctoral:general-education:cancel', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        self.mock_proposition_api.return_value.retrieve_general_education_proposition.return_value = Mock(
            statut=ChoixStatutPropositionGenerale.ADMITTED.name,
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, ChoixStatutPropositionGenerale.ADMITTED.value)
        response = self.client.post(url, {})
        self.assertRedirects(response, expected_url=resolve_url('parcours_doctoral:list'))
    ...
    def test_cancel_continuing_education_proposition(self):
        url = resolve_url('parcours_doctoral:continuing-education:cancel', pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        self.mock_proposition_api.return_value.retrieve_continuing_education_proposition.return_value = Mock(
            statut=ChoixStatutPropositionContinue.ADMITTED.name,
            links={'destroy_proposition': {'url': 'ok'}},
        ...
        self.assertEqual(response.status_code, 200)
        self.assertContains(response, ChoixStatutPropositionContinue.ADMITTED.value)
        response = self.client.post(url, {})
        self.assertRedirects(response, expected_url=resolve_url('parcours_doctoral:list'))
