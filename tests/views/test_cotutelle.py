...
class CotutelleTestCase(TestCase):
    ...
    def setUp(self):
        self.url = resolve_url("parcours_doctoral:update:cotutelle", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
    ...
    def test_cotutelle_get(self):
        url = resolve_url("parcours_doctoral:cotutelle", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
