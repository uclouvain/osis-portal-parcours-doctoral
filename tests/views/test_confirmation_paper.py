...
class ConfirmationPaperDetailViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.url = resolve_url("parcours_doctoral:confirmation-paper", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
...
class ConfirmationPaperFormViewTestCase(TestCase):
    ...
    def setUp(self):
        self.url = resolve_url(
            "parcours_doctoral:update:confirmation-paper",
...
@override_settings(OSIS_DOCUMENT_BASE_URL='http://dummyurl/')
class DoctorateConfirmationPaperCanvasExportViewTestCase(TestCase):
    @classmethod
    def setUpTestData(cls):
        cls.phd_student = PersonFactory()
        cls.api_default_params = {
    ...
    def setUp(self):
        self.url = resolve_url(
            "parcours_doctoral:confirmation-paper-canvas",
            pk="3c5cdc60-2537-4a12-a396-64d2e9e34876",
        )
