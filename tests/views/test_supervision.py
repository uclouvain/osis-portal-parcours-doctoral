...
class SupervisionTestCase(TestCase):
    ...
    def test_should_remove_supervision_member(self):
        url = resolve_url(
            "parcours_doctoral:remove-actor",
    ...
    def test_should_edit_external_supervision_member(self):
        url = resolve_url(
            "parcours_doctoral:edit-external-member",
            pk="3c5cdc60-2537-4a12-a396-64d2e9e34876",
            uuid="uuid-0123456978",
        )
        external_data = {
    ...
    def test_should_not_display_confirmation_if_errors(self):
        ...
        self.assertNotContains(response, _("Are you sure you want to request signatures for this PhD?"))
    ...
    def test_should_redirect_to_supervision_without_buttons(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.mock_api.return_value.retrieve_verify_project.assert_called()
        self.assertContains(response, _("Are you sure you want to request signatures for this PhD?"))

        # Success
        post_url = resolve_url("parcours_doctoral:request-signatures", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
    ...
    def test_should_approval_by_pdf_redirect_without_errors(self, *args):
        url = resolve_url("parcours_doctoral:approve-by-pdf", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
        response = self.client.post(url, {'matricule': "test", 'pdf_0': 'some_file'})
        expected_url = resolve_url("parcours_doctoral:supervision", pk="3c5cdc60-2537-4a12-a396-64d2e9e34876")
    ...
    def test_should_set_reference_promoter(self):
        url = resolve_url(
            "parcours_doctoral:set-reference-promoter",
            pk="3c5cdc60-2537-4a12-a396-64d2e9e34876",
            uuid="uuid-9876543210",
        )
        response = self.client.post(url, {})
